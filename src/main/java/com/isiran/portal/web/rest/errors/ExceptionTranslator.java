...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.isiran.portal.service.EmailAlreadyUsedException ||
            ex instanceof com.isiran.portal.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.isiran.portal.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.isiran.portal");
    }
}
